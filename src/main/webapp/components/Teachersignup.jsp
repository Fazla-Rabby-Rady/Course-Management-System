    ...
    <dir class=" w-full h-[80vh]">
            ...
            <div class=" h-[70vh] flex justify-center items-center space-x-20">
              <div class="w-[30%] h-[50vh] p-5 pl-24">
                <form action="/webproject/signup" method="post" class=" space-y-5">

                   <input type="text" name="role" value="teacher" id="" class="hidden" />
                   <input type="text" name="reg" value="teacherrole" id="" class="hidden" />
                  <input
                    type="text"
                  ...
                  />
                  <select name="dept" class=" border border-[2px] border-green-500 w-[90%] pl-2 h-[5vh] rounded-md placeholder:italic placeholder:text-slate-400 outline-none focus:outline-none focus:border-green-600 focus:ring-1 focus:ring-green-500 ">
                    <option value="selct" disabled selected>
                      --Select Your Depeartment---
                    </option>
