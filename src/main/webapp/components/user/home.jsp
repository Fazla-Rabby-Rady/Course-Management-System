...
<body>
    ...
    <jsp:include page="/components/user/navbar.jsp"/>
     ...
     <div class=" w-full flex justify-center pr-[5rem] pt-[8rem] space-x-10">

           <a href="/webproject/joinclass"

               class=" p-3 pl-10 pr-10 bg-red-500 text-xl text-white font-medium rounded-md hover:bg-[#333333]"
           >
                Join Class <span > <i class="fa-light fa-plus"></i> </span>
            </a>
     </div>
      ...
      <div class=" w-[100%] min-h-[90vh]  pt-16 pl-[2rem] pr-[2rem] flex flex-wrap justify-center space-x-10 ">
             ...
             <% for (Course course : (List<Course>) request.getAttribute("courses")) { %>
                         ...
                         <div class=" w-[25%] h-[35vh] shadow-lg rounded-xl hover:scale-110 ease-in duration-300">
                               <div class="">
                                  <img src="images/logo1.jpg" alt="" class=' h-[20vh] w-[100%] rounded-t-lg' />
                               </div>
