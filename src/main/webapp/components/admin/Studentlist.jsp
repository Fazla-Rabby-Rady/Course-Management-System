...
<body>
    ...
    <div class=" w-full mt-[5rem]">
        <h1 class=" text-center text-3xl font-semibold text-red-400">Students List</h1>
        <div class=" w-full min-h-[25vh] flex justify-center items-center">
...
<script>
   function handleClick(param) {
     ...
     var url = "/webproject/studentlist"; // replace with the URL of the server-side script that will handle the request
