...
<body>
    ...
    <jsp:include page="/components/teacher/navbar.jsp"/>
          ...
          <div class=" w-[100%] min-h-[90vh]  pt-16 pl-[2rem] pr-[2rem] flex flex-wrap justify-center space-x-10 ">
                     ...
                     <% for (Course course : (List<Course>) request.getAttribute("courses")) { %>
                            ...
                            <a href="/webproject/coursestudent?courseCode=<%=course.getCourseCode()%>">

                                 <div class=" w-[100%] h-[36vh] shadow-lg rounded-xl hover:scale-110 ease-in duration-300 ">
                                       <div class="">
                                          <img src="images/logo2.jpg" alt="" class=' h-[20vh] w-[100%]' />
                                       </div>
